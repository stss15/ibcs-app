...
const _schema = i.graph(
  {
    ...
    classPacing: i.entity({
      ...
      history: i.list(i.string()).optional(),
      accessibleSlides: i.list(i.json()).optional(),
    ...
    liveSessions: i.entity({
      ...
      slideHistory: i.list(i.string()).optional(),
      activeAssessments: i.list(i.json()).optional(),
    ...
    studentStates: i.entity({
      ...
      viewedSlides: i.list(i.string()).optional(),
