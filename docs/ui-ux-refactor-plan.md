...
| ID | Task | Dependencies | Status | Notes |
| --- | --- | --- | --- | --- |
| P2-001 | Refactor diagram/image hotspot engines to tokenised positioning | P0-002 | Planned | Replace inline coordinates with CSS variables where possible; document exceptions in changelog. |
